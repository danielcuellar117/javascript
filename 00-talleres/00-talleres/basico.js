...
let numeroIngresado = Number(prompt('ingresa un numero'))
...
4. Escribe un programa que le pida al usuario ingresar un número.
   ...
   */
let numeroBingBong = parseInt(prompt('Ingresa un numero'));
let residuo3 = numeroBingBong % 3;
let residuo5 = numeroBingBong % 5;
switch (true) {
    case residuo3 == 0 && residuo5 == 0:
